...
class MetaFields {
  ...
  // expects whitespace-normalized values, the first not ''
  constructLink (source, annotation, target) {
  ...
  constructTokens (link) {
    ...
    if (target === source) {
      ...
      if (annotation === undefined && this.TARGET.isDefault() && target.match(/^https?:/)) {
